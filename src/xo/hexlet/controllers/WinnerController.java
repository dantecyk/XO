...
public class WinnerController {
    ...
    public Figure getWineer(final Field field) {
        try {
            for (int i = 0; i < 3; i++)
    ...
    private boolean check(final Field field, final Point currentPoint, final IPoinGenerator pointGenerator) {
    ...
    private interface IPoinGenerator {
